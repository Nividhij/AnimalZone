                                    ...
                                    <div class="details-product-area">
                                        <div class="product-thumb-area">
                                            ...
                                            <div class="thumb-wrapper one filterd-items figure">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('uploads/products/' . $data->image_1) }})"><img src="{{ asset('uploads/products/' . $data->image_1) }}" alt="product-thumb">
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="thumb-wrapper two filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('uploads/products/' . $data->image_2) }})"><img src="{{ asset('uploads/products/' . $data->image_2) }}" alt="product-thumb">
                                                </div>
                                            </div>
                                            @endif
                                            ...
                                            <div class="thumb-wrapper three filterd-items hide">
                                                <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ asset('uploads/products/' . $data->image_3) }})"><img src="{{ asset('uploads/products/' . $data->image_3) }}" alt="product-thumb">
                                                </div>
                                            </div>
                                            @endif
                                            <div class="product-thumb-filter-group">
                                                ...
                                                <div class="thumb-filter filter-btn active" data-show=".one">
                                                    <img src="{{ asset('uploads/products/' . $data->image_1) }}" alt="product-thumb-filter" width="100%">
                                                </div>
                                                @endif
                                                @if($data->image_2)
                                                <div class="thumb-filter filter-btn" data-show=".two">
                                                    <img src="{{ asset('uploads/products/' . $data->image_2) }}" alt="product-thumb-filter">
                                                </div>
                                                @endif
                                                @if($data->image_3)
                                                <div class="thumb-filter filter-btn" data-show=".three">
                                                    <img src="{{ asset('uploads/products/' . $data->image_3) }}" alt="product-thumb-filter">
                                                </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="contents">
                                            <div class="product-status">
                                                <span class="product-catagory">{{$data->category_name}}</span>
                                            </div>
                                            <h2 class="product-title">{{$data->product_name}}</h2>
                                            <p class="mt--20 mb--20">
                                            {{   $data->description}}
                                            </p>
                                            <span class="product-price mb--15 d-block" style="color: #DC2626; font-weight: 600;">₹ {{$data->price}}</span>
                                            <div class="product-bottom-action">
                                                <a href="{{ route('enquiries.create' , ['product_id'=>$data->id]) }}" class="rts-btn btn-primary radious-sm with-icon">
                                                    <div class="btn-text">
                                                        Inquiry Now
                                                    </div>
                                                </a>
                                            ...
                                            <div class="product-uniques">
                                                <span class="sku product-unipue mb--10"><span style="font-weight: 400; margin-right: 10px;">City: </span> {{$data->location}}</span>
                                                @php
                                                $attributes = json_decode(  $data->attribute, true);
                                                @endphp

                                                @if(is_array($attributes))
                                                    @foreach($attributes as $attribute)
           
                                                        <span class="catagorys product-unipue mb--10"><span style="font-weight: 400; margin-right: 10px;">{{ key($attribute) }}: </span> {{ current($attribute) }}</span>
                                                    @endforeach
                                                @else
                                                ...
                                                <span class="tags product-unipue mb--10"><span style="font-weight: 400; margin-right: 10px;">Subcategory: </span> {{$data->subcategory_name}}</span>
                                            </div>
                                ...
                                <div class="tab-pane fade   show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                    <div class="single-tab-content-shop-details">
                                        ...
                                        <div class="details-row-2">
                                            <div class="left-area">
                                                <img src="{{URL::TO('/')}}/web/assets/images/shop/06.jpg" alt="shop">
                                            </div>
                                            <div class="right">
