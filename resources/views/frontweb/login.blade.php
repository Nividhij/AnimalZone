                ...
                <div class="col-lg-12">
                    <div class="registration-wrapper-1">
                        <div class="logo-area mb--0">
                            <img class="mb--10" src="{{URL::TO('/')}}/web/assets/images/logo/fav.png" alt="logo">
                        </div>
                        <h3 class="title">Login Into Your Account</h3>
                        <form action="{{route('loginsubmit')}}" class="registration-form" method="POST">
                            @csrf
                            ...
                            <div class="another-way-to-registration">
                                <p>Does Not Have Account? <a href="{{route('signup')}}">Sign Up</a></p>
                            </div>
                        </form>
                    </div>
                </div>
