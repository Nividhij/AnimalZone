<div class="rts-footer-area pt--80 bg_light-1">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="social-and-payment-area-wrapper">
                        ...
                        <div class="payment-access">
                            ...
                            <img src="{{ URL::TO('/front/') }}/assets/images/payment/01.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="copyright-between-1">
                        ...
                        <a href="#" class="playstore-app-area">
                            ...
                            <img src="{{ URL::TO('/front/') }}/assets/images/payment/02.png" alt="">
                            <img src="{{ URL::TO('/front/') }}/assets/images/payment/03.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="details-product-area">
                    <div class="product-thumb-area">
                        ...
                        <div class="thumb-wrapper one filterd-items figure">
                            <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ URL::TO('/front/') }}/assets/images/products/product-details.jpg)"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-details.jpg" alt="product-thumb">
                            </div>
                        </div>
                        <div class="thumb-wrapper two filterd-items hide">
                            <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ URL::TO('/front/') }}/assets/images/products/product-filt2.jpg)"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-filt2.jpg" alt="product-thumb">
                            </div>
                        </div>
                        <div class="thumb-wrapper three filterd-items hide">
                            <div class="product-thumb zoom" onmousemove="zoom(event)" style="background-image: url({{ URL::TO('/front/') }}/assets/images/products/product-filt3.jpg)"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-filt3.jpg" alt="product-thumb">
                            </div>
                        </div>
                        <div class="product-thumb-filter-group">
                            <div class="thumb-filter filter-btn active" data-show=".one"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-filt1.jpg" alt="product-thumb-filter"></div>
                            <div class="thumb-filter filter-btn" data-show=".two"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-filt2.jpg" alt="product-thumb-filter"></div>
                            <div class="thumb-filter filter-btn" data-show=".three"><img src="{{ URL::TO('/front/') }}/assets/images/products/product-filt3.jpg" alt="product-thumb-filter"></div>
                        </div>
                    </div>
                    <div class="contents">
                    ...
                    <div class="compare-main-wrapper-body">
                        ...
                        <div class="single-compare-elements">
                            <div class="thumbnail-preview">
                                <img src="{{ URL::TO('/front/') }}/assets/images/grocery/01.jpg" alt="grocery">
                            </div>
                        </div>
                        <div class="single-compare-elements">
                            <div class="thumbnail-preview">
                                <img src="{{ URL::TO('/front/') }}/assets/images/grocery/02.jpg" alt="grocery">
                            </div>
                        </div>
                        <div class="single-compare-elements">
                            <div class="thumbnail-preview">
                                <img src="{{ URL::TO('/front/') }}/assets/images/grocery/03.jpg" alt="grocery">
                            </div>
                        </div>
                    </div>
    ...
    <!-- plugins js -->
    <script defer src="{{ URL::TO('/front/') }}/assets/js/plugins.js"></script>

    <!-- custom js -->
    <script defer src="{{ URL::TO('/front/') }}/assets/js/main.js"></script>
