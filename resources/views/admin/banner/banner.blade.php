                    ...
                    <div id="bannerFields">
                        <div class="banner-field">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="offer" placeholder="Enter Offer Text" name="offer" value="{{old('offer')}}">
                                @error('offer')
                                ...
                                <input type="text" class="form-control" id="heading" placeholder="Enter Headig Text" name="heading" value="{{old('heading')}}">
                                @error('heading')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="button_heading" placeholder="Enter Button Title" name="button_heading" value="{{old('button_heading')}}">
